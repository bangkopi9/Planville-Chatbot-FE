...
window.CONFIG = {
  ...
  REQUEST_TIMEOUT_MS: 20000,              // hard-timeout per request (ms) → dipakai di stream
  SSE_HEARTBEAT_MS: 15000,                // watchdog: bila 2× interval tanpa data → abort agar auto-retry
  STREAM_TIMEOUT_MS: 60000,               // legacy/opsional (boleh dibiarkan)
  ...
  ENABLE_GUARDRAILS: true                 // biar gampang matiin/nyalain via ENV
};
